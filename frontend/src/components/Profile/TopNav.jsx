export default function TopNav(username) {
  return (
    <>
      <div className="bg-white w-full h-11 border-b border-zinc-200 text-center font-sans font-semibold pt-2">
        <span className="inline-block   absolute left-4 top-2.5 -rotate-90 hover:cursor-pointer">
